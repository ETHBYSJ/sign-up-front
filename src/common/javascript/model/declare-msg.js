...
export class DeclareMsg {
  constructor() {
    ...
    this.arriveId = new DataInputConfig('来沪航班/车次号', true, '', '请输入来沪航班/车次号', '')
    this.arriveTime = new DataInputConfig('到沪时间', true, '', '请选择到沪时间', '')
    this.leaveId = new DataInputConfig('离沪航班/车次号', true, '', '请输入离沪航班/车次号', '')
    this.leaveTime = new DataInputConfig('离沪时间', true, '', '请选择离沪时间', '')
  }
}